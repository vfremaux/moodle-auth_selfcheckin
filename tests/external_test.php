...
/**
 * External auth selfcheckin API tests.
 *
 * @package     auth_selfcheckin
 * @copyright   2016 Juan Leyva
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since       Moodle 3.2
 */
class auth_selfcheckin_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_get_signup_settings() {
        ...
        $result = auth_selfcheckin_external::get_signup_settings();
        $result = external_api::clean_returnvalue(auth_selfcheckin_external::get_signup_settings_returns(), $result);
    ...
    public function test_signup_user() {
        ...
        // Create new user.
        $result = auth_selfcheckin_external::signup_user($username, $password, $firstname, $lastname, $email, $city,  $country,
                                                    '', '', $customprofilefields);
        $result = external_api::clean_returnvalue(auth_selfcheckin_external::signup_user_returns(), $result);
